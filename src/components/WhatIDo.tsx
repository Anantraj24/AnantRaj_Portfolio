        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building portfolio websites, web apps, and modern frontends focusing on audience engagement.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing AI applications, analyzing data, and finding predictive solutions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>VIDEO EDITING</h3>
              <h4>Visuals & Post-Production</h4>
              <p>
                Crafting engaging video sequences, performing edits, and managing overall visuals.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Solving complex challenges, optimizing algorithms, and mastering computational logic.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
